          ...
          <div className="bg-white rounded-lg shadow-lg flex max-w-4xl w-full">
            ...
            <div className="flex flex-col items-center w-full md:w-1/2 p-8">
              ...
              <form onSubmit={handleLogin} className="w-full">
                ...
                <button type="submit" className="w-full bg-red-600 text-white py-2 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mb-4">Sign in</button>
